...
public class YourCarsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_your_cars, container, false);
        ...
        currentLog = sharedPreferences.getString("userName", "");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    ...
                    if(currentLog.equals(itemSnapshot.child("User").getValue(String.class))){
